...
class HoudiniPlugin (DeadlinePlugin):
    ...
    def RenderArgument(self):
        ...
        if simJob:
            ...
            trackerMachineSlave = tasks.GetTask(0).TaskSlaveMachineName
    ...
    def PreRenderTasks(self):
        ...
        if self.GetBooleanPluginInfoEntryWithDefault( "SimJob", False ) and self.GetCurrentTaskId() == "0":
    ...
    def HandleStdoutFrameProgress(self):
        ...
        elif self.ropType == "geometry" or self.ropType == "rop_geometry":
